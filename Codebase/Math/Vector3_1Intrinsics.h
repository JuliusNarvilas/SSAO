...
class Vector3_1Intrinsics	{
 public:
	...
	inline Vector3_1Intrinsics& ToZero() { mmvalue = _mm_setzero_ps(); return *this; }
	...
	inline Vector3_1Intrinsics& Invert() {mmvalue = _mm_mul_ps(mmvalue, _mm_set1_ps(-1.0f)); return *this; }
	...
	inline Vector3_1Intrinsics& Normalize() { mmvalue = _mm_mul_ps(mmvalue, _mm_rsqrt_ps(_mm_dp_ps(mmvalue, mmvalue, 0x77))); return *this; }
	...
	inline Vector3_1Intrinsics& operator+=(float v) { mmvalue = _mm_add_ps(mmvalue, _mm_set1_ps(v)); return *this; }
	inline Vector3_1Intrinsics& operator-=(float v) { mmvalue = _mm_sub_ps(mmvalue, _mm_set1_ps(v)); return *this; }
	inline Vector3_1Intrinsics& operator*=(float v) { mmvalue = _mm_mul_ps(mmvalue, _mm_set1_ps(v)); return *this; }
	inline Vector3_1Intrinsics& operator/=(float v) { mmvalue = _mm_div_ps(mmvalue, _mm_set1_ps(v)); return *this; }
	...
	inline Vector3_1Intrinsics& operator+=(const Vector3_1Intrinsics& v) { mmvalue = _mm_add_ps(mmvalue, v.mmvalue); return *this; }
	inline Vector3_1Intrinsics& operator-=(const Vector3_1Intrinsics& v) { mmvalue = _mm_sub_ps(mmvalue, v.mmvalue); return *this; }
	inline Vector3_1Intrinsics& operator*=(const Vector3_1Intrinsics& v) { mmvalue = _mm_mul_ps(mmvalue, v.mmvalue); return *this; }
	inline Vector3_1Intrinsics& operator/=(const Vector3_1Intrinsics& v) { mmvalue = _mm_div_ps(mmvalue, v.mmvalue); return *this; }
