...
void WheelObject::OnUpdateObject(float dt)
{
	...
	m_LocalTransform = Mat4Physics::Translation(LocalTrasformWORotate.GetTranslation()) * Mat4Physics::RotationY(30*rotFactor)* LocalTrasformWORotate.GetRotation() *  Mat4Physics::RotationX(dot * 0.5f);

	LocalTrasformWORotate = LocalTrasformWORotate * Mat4Physics::RotationX(dot * 0.5f);
